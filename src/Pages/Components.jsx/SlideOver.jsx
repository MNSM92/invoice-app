                ...
                >
                  <Dialog.Panel className="pointer-events-auto relative w-screen lg:max-w-[40%] md:max-w-[80%]">
                    ...
                    <div className="h-full bg-gray-50 dark:bg-black rounded-r-3xl shadow-xl px-6 py-6">
                      <div className="flex h-full flex-col overflow-y-scroll pr-4 dark:text-gray-200">
                            ...
                            <div className="col-span-1">
                              ...
                              <div className="mt-2.5">
                                <input
                                  ...
                                  id="first-name"
                                  autoComplete="given-name"
                                  className="block w-full rounded-md border-0 px-3.5 py-2 bg-inherit text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                />
                              </div>
                            </div>
                          </div>
                          ...
                          <button className="w-full h-12 rounded-full mt-2 mb-20 bg-gray-100 dark:bg-dark-primary dark:hover:bg-dark-secondary hover:bg-slate-primary font-bold text-gray-500">
                            +Add New Item
                                ...
                                <div className='relative w-full h-auto'>
                                    <div className='fixed w-[86%] bottom-2 flex flex-row justify-end h-16 bg-white dark:bg-black py-2'>
                                        
                                        <div className='flex flex-row justify-between space-x-2 w-auto h-full'>
                                        <button onClick={()=>setOpen(false)} className='w-auto h-full px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-full'>Cancel</button>
                                        <button className='w-auto h-full px-6 py-2 bg-indigo-secondary hover:bg-indigo-primary text-white rounded-full'>Save Changes</button>
